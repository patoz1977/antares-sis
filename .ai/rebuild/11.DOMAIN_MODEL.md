...
User es una Entity interna con identidad y lifecycle propios. Toda cuenta User pertenece exactamente a esta Person; Person puede existir sin User.
...
PersonCreated; los eventos de User se originan en Person a través de su Entity interna User.
...
| FamilyEmergencyContact | Recurso de emergencia con nombre, relación y datos de contacto propios. | No es Person; puede reutilizarse entre Students de la misma Family. |
...
| UserCreated | Person (Entity User) | creación | Cuenta de acceso creada para una Person. | Auditoría. |
| UserActivated | Person (Entity User) | activación | Cuenta de una Person habilitada para acceso. | Representative Portal. |
| UserDisabled | Person (Entity User) | desactivación | Cuenta de una Person deja de poder acceder. | Representative Portal. |
