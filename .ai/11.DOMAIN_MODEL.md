...
Crear y actualizar identidad y contacto autorizado, conservando unicidad institucional. Cuando exista un User de Representative, la actualización de Identification se coordina externamente con User y no puede retirar la identificación completa.

### Invariantes

Una Person representa una sola identidad institucional. Toda cuenta User pertenece exactamente a una Person y no duplica sus datos personales; una Person puede existir sin User. Una Person que tenga un User de Representative conserva obligatoriamente DocumentTypeId y DocumentNumber completos. Student y Representative la referencian; Student no tiene User ni Portal en el MVP.
...
Los cambios de identidad se protegen dentro de Person; los roles y accesos se coordinan externamente. Cambiar el DocumentNumber de una Person con User de Representative modifica también User.LoginIdentifier en una sola transacción exterior, o no persiste ningún cambio.
