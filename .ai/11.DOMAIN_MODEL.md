...
E015 crea o reconoce únicamente el mínimo de Family, Representative con User, Student y membresías definido en `17.BULK_IMPORT_BASELINE.md`. La operación es idempotent create, nunca upsert: una identidad existente equivalente se reconoce, una incompatible produce conflicto y los datos vivos existentes no se sobrescriben. Todo el archivo se valida antes de escribir y cada Family es una unidad transaccional independiente. `family_ref` correlaciona filas del archivo, pero no es identidad persistente ni relación de dominio.
...
FamilyId es la identidad técnica. FamilyCode es la identidad funcional persistente, única dentro de la institución, estable e independiente de DisplayName. El formato, generación y representación física de FamilyCode permanecen pendientes del diseño autorizado de E015 Phase 2.
