...
Referencia a Student, Family y AcademicPeriod; AcademicPlacement; BillingInformation; MedicalInformation; TransportInformation; IsAuthorizedToLeaveAlone; lifecycle y EnrollmentSubmissionSnapshot.
...
EnrollmentSubmissionSnapshot pertenece conceptualmente al Enrollment anual. Institutional Acknowledgements pertenece a un contexto separado y no contiene Entity interna dentro de Enrollment.
...
Los cambios de información anual, estado y snapshot se confirman atómicamente dentro de Enrollment y sus entidades internas. Submission valida autorización, membresía, recursos de Family y satisfacción de Institutional Acknowledgements mediante un boundary explícito, pero no modifica Person, Student, Family ni los Aggregates de acknowledgements.
...
Copia exclusivamente la dirección seleccionada del Student, sus emergency contacts activos asignados y sus authorized pickups activos asignados. La dirección copiada contiene Label, MainStreet, StreetNumber, SecondaryStreet, Sector, Reference y Geolocation según existan en FamilyAddress; no contiene Province, Canton o Parish ni valores derivados. RelationshipType y DocumentType conservan los valores visibles y códigos estables necesarios para lectura histórica, sin referencias mutables a catálogos ni recursos Family. No copia recursos no asignados, Person completa, Representative completo, Student completo, Family completa, BillingInformation, MedicalInformation, TransportInformation, AcademicPlacement ni Institutional Acknowledgements. Los datos anuales permanecen directamente en Enrollment.
...
Coordina la validación de Submission cuando intervienen Enrollment, Family, Representative, Student, AcademicPeriod e Institutional Acknowledgements. Exige autorización, membresía activa, recursos familiares válidos, etapa de acknowledgements satisfecha y datos anuales completos. Modifica exclusivamente Enrollment y sus entidades internas al producir Submitted y snapshot; los demás Aggregates solo se consultan y validan. La regla cruza límites de Aggregate y por eso no pertenece a uno solo.
...
Los cambios internos de Person, User, Representative, Student, AcademicPeriod, Family, Enrollment, AcknowledgementRequirement y RepresentativeAcknowledgementCompletion se mantienen con consistencia fuerte en su Aggregate. Family controla sus membresías y recursos; Enrollment controla su lifecycle, información anual y snapshot; Completion controla atómicamente sus acknowledgements internos.
...
Submission coordina la validación de autorización, membresía, selección de recursos y satisfacción de Institutional Acknowledgements entre Aggregates. La única modificación de negocio de Submission recae en Enrollment y sus entidades internas: creación o reemplazo del snapshot y transición de estado en una operación atómica. Person, Student, Family y los Aggregates de acknowledgements se consultan para validar y no se modifican. La creación previa de una Completion, cuando corresponda, es otra operación atómica independiente. Las validaciones cross-aggregate se coordinan por Domain Services o Application boundaries explícitos; las notificaciones y demás reacciones ocurren después del commit mediante Domain Events.
...
Responsabilidad: Enrollment anual, lifecycle, declaraciones anuales y snapshot. Publica sus eventos de ciclo; consume identidad, acceso autorizado, Family, Student, AcademicPeriod, Catalogs y un contrato de satisfacción de Institutional Acknowledgements. No sustituye los contextos que poseen esos conceptos.
