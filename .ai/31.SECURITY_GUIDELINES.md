...
- validate true file format, expected workbook structure and content, not only extension, and enforce a bounded file size whose numeric limit is decided during technical design;
...
- delete temporary workbooks after processing and do not retain the source XLSX as historical evidence without a future explicit decision;
- minimize imported personal data and return safe errors without secrets or unnecessary PII.

Phase 1 defines no upload, parser, temporary-storage or output-file implementation.
