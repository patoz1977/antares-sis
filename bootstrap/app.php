...
$container->singleton(BulkImportWorkbookReader::class, OpenSpoutBulkImportWorkbookReader::class);
$container->singleton(BulkImportCatalogResolver::class, PdoBulkImportCatalogResolver::class);
...
$container->singleton(FamilyCodeGenerator::class, RandomFamilyCodeGenerator::class);
...
$container->singleton(AddRepresentativeToFamily::class, AddRepresentativeToFamily::class);
...
$container->singleton(StudentFamilyCoordinator::class, StudentFamilyCoordinator::class);
