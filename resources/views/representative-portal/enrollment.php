...
$autosaveFeedback = static function (string $section) use ($escape): void {
    ...
    <div class="col-12" data-enrollment-autosave-feedback="<?= $escape($section) ?>">
        <span data-enrollment-autosave-status role="status" aria-live="polite"></span>
...
<section class="mb-4" aria-labelledby="acknowledgements-heading">
    ...
    <p><a href="/representative/acknowledgements" data-enrollment-navigation>Review Institutional Acknowledgements</a></p>
...
<section class="mb-4" aria-labelledby="progress-heading">
    ...
    <ul>
        <li>Institutional Acknowledgements: <span data-progress-section="acknowledgements"><?= $escape($status($portal->progress->acknowledgements)) ?></span></li>
        <li>Representative Personal: <span data-progress-section="representative-personal"><?= $escape($status($portal->progress->representativePersonal)) ?></span></li>
        <li>Representative Contact: <span data-progress-section="representative-contact"><?= $escape($status($portal->progress->representativeContact)) ?></span></li>
        <li>Employment: <span data-progress-section="representative-employment"><?= $escape($status($portal->progress->employment)) ?></span></li>
        <li>Student Personal: <span data-progress-section="student-personal"><?= $escape($status($portal->progress->studentPersonal)) ?></span></li>
        <li>Student Address: <span data-progress-section="student-address"><?= $escape($status($portal->progress->studentAddress)) ?></span></li>
        <li>Academic Placement: <span data-progress-section="academic-placement"><?= $escape($status($portal->progress->academicPlacement)) ?></span></li>
        <li>Billing: <span data-progress-section="billing"><?= $escape($status($portal->progress->billing)) ?></span></li>
        <li>Medical: <span data-progress-section="medical"><?= $escape($status($portal->progress->medical)) ?></span></li>
        <li>Transport: <span data-progress-section="transport"><?= $escape($status($portal->progress->transport)) ?></span></li>
        <li>Emergency Contacts: <span data-progress-section="emergency-contacts"><?= $escape($status($portal->progress->emergencyContacts)) ?></span></li>
        <li>Pickup or leave-alone: <span data-progress-section="leave-alone"><?= $escape($status($portal->progress->pickupOrLeaveAlone)) ?></span></li>
    </ul>
    <?php if ($context->acknowledgementsSatisfied): ?>
    <p><a href="/representative/resources" data-enrollment-navigation>Maintain addresses, emergency contacts and authorized pickups in Family Resources</a>.</p>
    <?php endif; ?>
</section>
<?php endif; ?>
...
<section class="mb-4" aria-labelledby="representative-personal-heading">
    ...
    <form method="post" action="/representative/enrollment/representative/personal" class="row g-3" data-enrollment-autosave data-section="representative-personal">
        ...
        <div class="col-12"><button type="submit" class="btn btn-primary" data-enrollment-fallback-save>Save Personal Information</button></div>
    </form>
    <?php endif; ?>
</section>
...
<section class="mb-4" aria-labelledby="representative-contact-heading">
    ...
    <form method="post" action="/representative/enrollment/representative/contact" class="row g-3" data-enrollment-autosave data-section="representative-contact">
        ...
        <div class="col-12"><button type="submit" class="btn btn-primary" data-enrollment-fallback-save>Save Contact Information</button></div>
    </form>
    <?php endif; ?>
</section>
...
<section class="mb-4" aria-labelledby="employment-heading">
    ...
    <form method="post" action="/representative/enrollment/representative/employment" class="row g-3" data-enrollment-autosave data-section="representative-employment">
        ...
        <div class="col-12"><button type="submit" class="btn btn-primary" data-enrollment-fallback-save>Save Employment Information</button></div>
    </form>
    <?php endif; ?>
</section>
...
<section class="mb-4" aria-labelledby="student-personal-heading">
    ...
    <form method="post" action="/representative/enrollment/student/personal" class="row g-3" data-enrollment-autosave data-section="student-personal">
        ...
        <div class="col-12"><button type="submit" class="btn btn-primary" data-enrollment-fallback-save>Save Student Information</button></div>
    </form>
    <?php endif; ?>
</section>
...
<section class="mb-4" aria-labelledby="billing-heading">
    ...
    <form method="post" action="/representative/enrollment/student/billing" class="row g-3" data-enrollment-autosave data-section="billing">
        ...
        <div class="col-12"><button type="submit" class="btn btn-primary" data-enrollment-fallback-save>Save Billing Information</button></div>
    </form>
</section>
...
<section class="mb-4" aria-labelledby="medical-heading">
    ...
    <form method="post" action="/representative/enrollment/student/medical" class="row g-3" data-enrollment-autosave data-section="medical">
        ...
        <div class="col-12"><button type="submit" class="btn btn-primary" data-enrollment-fallback-save>Save Medical Information</button></div>
    </form>
</section>
...
<section class="mb-4" aria-labelledby="transport-heading">
    ...
    <form method="post" action="/representative/enrollment/student/transport" data-enrollment-autosave data-section="transport">
        ...
        <button type="submit" class="btn btn-primary" data-enrollment-fallback-save>Save Transport Information</button>
    </form>
</section>
...
<section class="mb-4" aria-labelledby="leave-alone-heading">
    ...
    <form method="post" action="/representative/enrollment/student/leave-alone" data-enrollment-autosave data-section="leave-alone">
        ...
        <button type="submit" class="btn btn-primary" data-enrollment-fallback-save>Save Leave-alone Authorization</button>
    </form>
</section>
