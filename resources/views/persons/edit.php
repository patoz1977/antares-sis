    ...
    <div>
        ...
        <select id="status_id" name="status_id" required>
            ...
            <?php foreach ($statuses as $status): ?>
                ...
                <option value="<?= htmlspecialchars((string) $statusId, ENT_QUOTES, 'UTF-8') ?>" <?= $isSelected($person['status_id'] ?? null, $statusId) ? 'selected' : '' ?>>
    ...
    <div>
        ...
        <select id="document_type_id" name="document_type_id" required>
            ...
            <?php foreach ($documentTypes as $documentType): ?>
                ...
                <option value="<?= htmlspecialchars((string) $documentTypeId, ENT_QUOTES, 'UTF-8') ?>" <?= $isSelected($person['document_type_id'] ?? null, $documentTypeId) ? 'selected' : '' ?>>
    ...
    <div>
        ...
        <select id="gender_id" name="gender_id">
            ...
            <?php foreach ($genders as $gender): ?>
                ...
                <option value="<?= htmlspecialchars((string) $genderId, ENT_QUOTES, 'UTF-8') ?>" <?= $isSelected($person['gender_id'] ?? null, $genderId) ? 'selected' : '' ?>>
    ...
    <div>
        ...
        <select id="nationality_id" name="nationality_id">
            ...
            <?php foreach ($nationalities as $nationality): ?>
                ...
                <option value="<?= htmlspecialchars((string) $nationalityId, ENT_QUOTES, 'UTF-8') ?>" <?= $isSelected($person['nationality_id'] ?? null, $nationalityId) ? 'selected' : '' ?>>
