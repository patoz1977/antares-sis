...
final class CreateDocumentTypesTable extends Migration
{
    public function up(PDO $connection): void
    {
        $this->createTable($connection, 'document_types', function (Blueprint $table): void {
            $table->id();
            ...
            $table->index('name', 'document_types_name_idx');
        }, [
    ...
    {
        (new Schema())->drop('document_types');
    }

    public function version(): string
    {
        return '006_create_document_types_table';
    }
