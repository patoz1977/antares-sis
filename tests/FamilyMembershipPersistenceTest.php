...
function sqliteFamilyDatabase(bool $enforceAggregateConstraints = true): PDO
{
    ...
    $pdo->exec(
        ...
        . 'id INTEGER PRIMARY KEY AUTOINCREMENT, family_id INTEGER NOT NULL, label TEXT NOT NULL, '
        . 'main_street TEXT NOT NULL, street_number TEXT NULL, secondary_street TEXT NULL, '
        . 'sector TEXT NULL, reference TEXT NULL, latitude TEXT NULL, longitude TEXT NULL, '
        . 'status_id INTEGER NOT NULL, created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP, '
        . 'updated_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP, UNIQUE (id, family_id), '
        . 'CHECK ((latitude IS NULL) = (longitude IS NULL)), '
        . 'CHECK (latitude IS NULL OR (CAST(latitude AS REAL) BETWEEN -90 AND 90)), '
        . 'CHECK (longitude IS NULL OR (CAST(longitude AS REAL) BETWEEN -180 AND 180)), '
        . 'FOREIGN KEY (family_id) REFERENCES families(id), FOREIGN KEY (status_id) REFERENCES statuses(id));'
        . 'CREATE TABLE representative_address_assignments ('
        . 'id INTEGER PRIMARY KEY AUTOINCREMENT, family_id INTEGER NOT NULL, family_address_id INTEGER NOT NULL, '
        . 'representative_id INTEGER NOT NULL, started_at TEXT NOT NULL, ended_at TEXT NULL, '
        . 'created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP, '
        . 'UNIQUE (family_id, representative_id, started_at)'
        . $dateCheck . ', FOREIGN KEY (family_address_id, family_id) REFERENCES family_addresses(id, family_id), '
        . 'FOREIGN KEY (representative_id) REFERENCES representatives(id));'
        . 'CREATE TABLE student_address_assignments ('
        . 'id INTEGER PRIMARY KEY AUTOINCREMENT, family_id INTEGER NOT NULL, family_address_id INTEGER NOT NULL, '
        . 'student_id INTEGER NOT NULL, started_at TEXT NOT NULL, ended_at TEXT NULL, '
        . 'created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP, '
        . 'UNIQUE (family_id, student_id, started_at)'
        . $dateCheck . ', FOREIGN KEY (family_address_id, family_id) REFERENCES family_addresses(id, family_id), '
        . 'FOREIGN KEY (student_id) REFERENCES students(id));'
        . 'CREATE TABLE family_emergency_contacts ('
        . 'id INTEGER PRIMARY KEY AUTOINCREMENT, family_id INTEGER NOT NULL, names TEXT NOT NULL, '
        . 'relationship_type_id INTEGER NOT NULL, mobile_phone TEXT NOT NULL, phone TEXT NULL, email TEXT NULL, '
        . 'observations TEXT NULL, status_id INTEGER NOT NULL, created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP, '
        . 'updated_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP, UNIQUE (id, family_id), '
        ...
        . 'id INTEGER PRIMARY KEY AUTOINCREMENT, family_id INTEGER NOT NULL, '
        . 'family_emergency_contact_id INTEGER NOT NULL, student_id INTEGER NOT NULL, priority INTEGER NULL, '
        . 'started_at TEXT NOT NULL, ended_at TEXT NULL, created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP, '
        . 'updated_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP, '
        . 'UNIQUE (family_emergency_contact_id, student_id, started_at), '
        . 'CHECK (priority IS NULL OR priority > 0)'
        . $dateCheck . ', FOREIGN KEY (family_emergency_contact_id, family_id) '
        . 'REFERENCES family_emergency_contacts(id, family_id), FOREIGN KEY (student_id) REFERENCES students(id));'
        . 'CREATE TABLE family_authorized_pickups ('
        . 'id INTEGER PRIMARY KEY AUTOINCREMENT, family_id INTEGER NOT NULL, names TEXT NOT NULL, '
        . 'relationship_type_id INTEGER NOT NULL, mobile_phone TEXT NOT NULL, phone TEXT NULL, '
        . 'document_type_id INTEGER NULL, document_number TEXT NULL, observations TEXT NULL, status_id INTEGER NOT NULL, '
        . 'created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP, '
        . 'UNIQUE (id, family_id), CHECK ((document_type_id IS NULL) = (document_number IS NULL)), '
        . 'FOREIGN KEY (family_id) REFERENCES families(id), '
        . 'FOREIGN KEY (relationship_type_id) REFERENCES relationship_types(id), '
        ...
        . 'id INTEGER PRIMARY KEY AUTOINCREMENT, family_id INTEGER NOT NULL, '
        . 'family_authorized_pickup_id INTEGER NOT NULL, student_id INTEGER NOT NULL, '
        . 'started_at TEXT NOT NULL, ended_at TEXT NULL, created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP, '
        . 'updated_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP, '
        . 'UNIQUE (family_authorized_pickup_id, student_id, started_at)'
        . $dateCheck . ', FOREIGN KEY (family_authorized_pickup_id, family_id) '
        . 'REFERENCES family_authorized_pickups(id, family_id), FOREIGN KEY (student_id) REFERENCES students(id));'
    ...
    if ($enforceAggregateConstraints) {
        $pdo->exec(
            ...
            . 'CREATE UNIQUE INDEX uq_representative_address_active '
            . 'ON representative_address_assignments (family_id, representative_id) WHERE ended_at IS NULL;'
            . 'CREATE UNIQUE INDEX uq_student_address_active '
            . 'ON student_address_assignments (student_id) WHERE ended_at IS NULL;'
            . 'CREATE UNIQUE INDEX uq_emergency_assignment_active '
            . 'ON emergency_contact_assignments (family_emergency_contact_id, student_id) WHERE ended_at IS NULL;'
            . 'CREATE UNIQUE INDEX uq_emergency_priority_active '
            . 'ON emergency_contact_assignments (student_id, priority) '
            . 'WHERE ended_at IS NULL AND priority IS NOT NULL;'
            . 'CREATE UNIQUE INDEX uq_pickup_assignment_active '
            . 'ON authorized_pickup_assignments (family_authorized_pickup_id, student_id) WHERE ended_at IS NULL;'
        );
    }
    ...
    $pdo->exec('INSERT INTO document_types (id) VALUES (1), (2)');
